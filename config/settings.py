...
connect_request_message = "Hi! I just applied to your open role. As a Working Student with strong Software Engineering skills, I would love to connect and discuss how I can add value to your team."  # Leave Empty to send connection request without personalized invitation (recommended to leave it empty, since you only get 10 per month without LinkedIn Premium*)
