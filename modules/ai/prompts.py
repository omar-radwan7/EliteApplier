...
Write a highly customized, compelling, and concise cover letter (max 3 short paragraphs) for the following job description.
Use the candidate's information to align their skills with the job requirements.
Do NOT include placeholder blocks like [Date] or [Company Address]. Start directly with "Dear Hiring Team," or "Dear [Company Name] Team,".
...
Write a professional, personalized LinkedIn connection request note (maximum 300 characters) to the hiring manager for the following job.
The note should be polite, mention the specific role, and express enthusiasm based on the candidate's background.
